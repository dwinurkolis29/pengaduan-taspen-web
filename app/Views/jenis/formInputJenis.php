...
<h2>Input Data jenis Pengaduan</h2>

            <form action="<?=base_url()?>/jenis/simpanData" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label >Nama jenis Pengaduan:</label>
                    <input type="text" name="nama_j" class="form-control" placeholder="Masukan Nama jenis pengaduan" required/>
                </div>
                <br>
